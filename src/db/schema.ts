...
export const foods = pgTable(
  'foods',
  {
    ...
    protein: numeric({ precision: 8, scale: 2 }).notNull(),
    carbs: numeric({ precision: 8, scale: 2 }).notNull(),
    fat: numeric({ precision: 8, scale: 2 }).notNull(),
...
export const userGoals = pgTable(
  'user_goals',
  {
    ...
    weightTargetKg: numeric({ precision: 5, scale: 2 }),
...
export const mealItems = pgTable(
  'meal_items',
  {
    ...
    unit: text().notNull(),
    quantityGrams: numeric({ precision: 8, scale: 2 }).notNull(),
...
export const weightLogs = pgTable(
  'weight_logs',
  {
    ...
    bodyFatPct: numeric({ precision: 4, scale: 2 }),
    waistCm: numeric({ precision: 5, scale: 2 }),
    neckCm: numeric({ precision: 5, scale: 2 }),
    hipsCm: numeric({ precision: 5, scale: 2 }),
    loggedAt: timestamp({ withTimezone: true }).notNull(),
    createdAt: timestamp({ withTimezone: true }).defaultNow().notNull(),
    deletedAt: timestamp({ withTimezone: true }),
  },
